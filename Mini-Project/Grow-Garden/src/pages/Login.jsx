...
const Login = () => {
  ...
  return (
    <div className="bg-[#E3DBC7] min-h-screen flex items-center justify-center">
      <div className="bg-[#FDFBF8] p-10 rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border ${errorMessage.password || errorMessage.invalid ? 'border-red-500' : 'border-[#E3DBC7]'} bg-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#84A575]`}
            />
